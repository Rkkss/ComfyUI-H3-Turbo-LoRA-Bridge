...
Backbone 0.25-0.45 
(0.45 is the most stable based on my tests; other values can improve quality/prompt but are more prone to Artifacts. It works as pseudo "model_strength". I'm unsure; leave it for now. Lower value to see if you can get away with it)
